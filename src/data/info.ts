export const info = {
  name: " Nour Chamas",
  brief_description: "une développeuse front-end passionnée",
  ...
  projects: [
    {
      title: " Portfolio",
      date: "2024",
      description: "An interactive portfolio website showcasing my mischievous coding projects.",

      tech: ["React", "Node.js"],
      img_alt: "portfolio",
      img_path: "/screenshot nour.png",
    },
    {
      title: "Debuggez le site ",
      date: "2023",
      description: ":Débugger un site web 724 events.",
      link: "https://github.com/nourchamas/Debuggez-le-site_projet10.git",
      tech: ["React", "test unitaires"],
      img_alt: "724events",
      img_path: "/724 events .png",
    },
    {
      title: "Booki",
      date: "2023",
      description: "Description :Créez la page d'accueil d'une agence de voyage avec HTML & css",
      link: "https://github.com/nourchamas/Booki.git",
      tech: ["Html", "css"],
      img_alt: "Booki",
      img_path: "/booki projet.png",
    },
    {
      title: "Kaza",
      date: "2024",
